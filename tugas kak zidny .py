...
def fungsimakanan():
   ...
   global jenis1
   print ("\n~~~~Menu Makanan~~~~")
   print("1. Lalapan Ayam - Rp15000")
   print("2. Sate - Rp9000")
   print("3. Sop Ayam - Rp11000")
   nomor=int(input("Masukan Pilihan: "))
   porsi= int(input("Berapa Porsi: "))
   
   if nomor==1:
       total1=porsi*15000
       print (porsi," porsi Lalapan Ayam = Rp", total1)
       jenis1=("Lalapan Ayam ")
   elif nomor==2:
       total1=porsi*9000
       print (porsi," porsi Sate = Rp", total1)
       jenis1=("Sate")
   elif nomor==3:
       total1=porsi*11000
       print (porsi, " porsi Sop Ayam  = Rp", total1)
       jenis1=("Sop Ayam ")
   else:
...
def fungsiminuman():
   ...
   if nomor==1:
       ...
       total2=gelas*4000
       print (gelas, " Gelas Jus Buah = Rp", total2)
       jenis2=("Jus Buah")
   else:
      print("Pilihan tidak ada, silahkan masukan lagi!!")
      fungsiminuman()
